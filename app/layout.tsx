    ...
    <html lang="pt-br">
      <body className={`${inter.className} bg-gray-100 text-gray-900`}>
        <div className="flex flex-col md:flex-row h-screen overflow-hidden">
          ...
          {/* TOPO MOBILE */}
          <div className="md:hidden fixed top-0 left-0 right-0 h-16 flex items-center justify-between px-4 bg-white border-b border-black/5 z-50 shadow-sm">
            <Link 
              href="/" 
          ...
          {/* SIDEBAR */}
          <aside className={`
            fixed inset-y-0 left-0 z-40 w-64 bg-white border-r border-black/5 flex flex-col shadow-sm transition-transform duration-300
            ${isMenuOpen ? 'translate-x-0' : '-translate-x-full'}
            md:relative md:translate-x-0
          `}>
            <div className="p-6 border-b border-black/5 mb-4 hidden md:block">
            ...
            <div className="p-4 border-t border-black/5">
              <button 
                ...
                className="w-full flex items-center justify-center gap-2 p-3 rounded-xl bg-gray-100 text-gray-500 font-black text-[10px] uppercase hover:bg-red-50 hover:text-red-600 transition-all"
              >
                🚪 Sair do Sistema
              </button>
            </div>
          ...
          {/* CONTEÚDO */}
          <main className="flex-1 overflow-y-auto p-4 md:p-8 pt-20 md:pt-8 bg-gray-100">
